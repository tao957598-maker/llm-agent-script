import{_ as d,k as o,c as p,aU as t,g as s,u as a,bp as m,a_ as _,b5 as I,bK as f,bL as P,o as R}from"./index-B6YLXGex.js";const h={class:"mermaid-editor flex",style:{"overflow-y":"auto"}},y={class:""},D={__name:"mermaidEditor",setup(F){const r=o([{design_element:"UI场景(视觉)",test_content:["验证搜索界面是否清晰显示OKP Group名称输入框","验证搜索结果列表是否明确展示匹配的CDD案例"]},{design_element:"栏位和按钮",test_content:["Validate Group ID field input constraints (length, format)"]}]),e=o(`sequenceDiagram
