import{_ as m}from"./VueJson-DC6NVdqj.js";import{_ as p}from"./MermaidChart-mLeJE-GD.js";import{_ as d,j as r,c as _,g as t,k as s,u as o,m as I,F as f,q as P,o as R}from"./index-BJ82wnYV.js";import"./mermaid.core-BjDjRCcP.js";const F={class:"mermaid-editor flex",style:{"overflow-y":"auto"}},h={class:""},y={__name:"mermaidEditor",setup(D){const n=r([{design_element:"UI场景(视觉)",test_content:["验证搜索界面是否清晰显示OKP Group名称输入框","验证搜索结果列表是否明确展示匹配的CDD案例"]},{design_element:"栏位和按钮",test_content:["Validate Group ID field input constraints (length, format)"]}]),e=r(`sequenceDiagram
